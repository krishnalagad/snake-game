...
//			}
	...
	public void newApple() {
		this.appleX = this.random.nextInt((int)SCREEN_WIDTH / UNIT_SIZE) * UNIT_SIZE;
		this.appleY = this.random.nextInt((int)SCREEN_HEIGHT / UNIT_SIZE) * UNIT_SIZE;
	}
	public void move() {
	...
	public void gameOver(Graphics g) {
		...
		g.drawString("Your Score: " + this.applesEaten, (SCREEN_WIDTH - metrics1.stringWidth("Your Score: " + this.applesEaten)) / 2, g.getFont().getSize());
